...
void TProg () {
	...
	TLSTRASS(4095, systemname, __x87);
    };
    {
	TLstring	__x88;
	...
	TLSTRASS(4095, granularity, __x88);
    };
    {
	TLstring	__x89;
	...
	if (TL_TLS_TLSIND(line, "<classinfo ") == 1) {
		...
		for(;;) {
			...
			for(;;) {
				...
				{
				    TLchar	__x109[102];
				    TL_TLS_TLSBXX(__x109, (TLint4) 199, (TLint4) 100, line);
				    {
					TLstring	__x110;
				...
				{
				    TLstring	__x111;
				    TL_TLS_TLSBXS(__x111, (TLint4) 0, (TLint4) 199, line);
				    {
					TLstring	__x112;
					encode(__x111, __x112);
					TL_TLI_TLISS ((TLint4) ccf, (TLint2) 2);
					TL_TLI_TLIPS ((TLint4) 0, __x112, (TLint2) ccf);
				    };
				};
			    };
				...
				{
				    TLchar	__x113[102];
				    TL_TLS_TLSBXX(__x113, (TLint4) 100, (TLint4) 1, line);
				    {
					TLstring	__x114;
				...
				{
				    TLchar	__x115[102];
				    TL_TLS_TLSBXX(__x115, (TLint4) 199, (TLint4) 100, line);
				    {
					TLstring	__x116;
					encode(__x115, __x116);
					TL_TLI_TLISS ((TLint4) ccf, (TLint2) 2);
					TL_TLI_TLIPS ((TLint4) 0, __x116, (TLint2) ccf);
				    };
				};
				{
				    TLstring	__x117;
				    TL_TLS_TLSBXS(__x117, (TLint4) 0, (TLint4) 199, line);
				    {
					TLstring	__x118;
					encode(__x117, __x118);
					TL_TLI_TLISS ((TLint4) ccf, (TLint2) 2);
					TL_TLI_TLIPS ((TLint4) 0, __x118, (TLint2) ccf);
				    };
				};
			    } else {
				{
