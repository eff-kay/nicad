...
static void showpairs () {
	...
	TLSTRASS(4095, systeminfo, __x296);
    };
...
static void getprogramarguments () {
	...
	TLSTRASS(4095, pcfile, __x310);
    };
    {
	TLstring	__x311;
	TL_TLI_TLIFA((TLint4) 2, __x311);
	TLSTRASS(4095, npcfile, __x311);
    };
    if (TL_TLI_TLIARC > 2) {
	{
	    TLstring	__x312;
